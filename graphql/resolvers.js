...
module.exports = {
    ...
    createPost:async function (args, req) {
        ...
        const errors=[];
        if(validator.isEmpty(args.postInput.title)||!validator.isLength(args.postInput.title,{min:3})){
            errors.push({message:'Title is invalid.'});
        }
        if(validator.isEmpty(args.postInput.content)||!validator.isLength(args.postInput.content,{min:3})){
